...
def test_named_dialog_views_match_the_authoritative_width_and_height_profiles() -> None:
    expected = {
        ...
        DialogSizeClass.TRANSACTION: {
            ...
            "fertilizer-purchase": (520, 540, 560, 300, 330, 340),
        ...
        DialogSizeClass.NURSERY: {
            ...
            "plants": (640, 940, 950, 300, 320, 380),
            "owned": (640, 940, 950, 470, 500, 530),
            "fertilizer": (640, 940, 950, 560, 640, 680),
            "spaces": (640, 940, 950, 330, 360, 410),
            "garden_features": (640, 940, 950, 560, 640, 680),
            "collection-complete": (640, 940, 950, 290, 320, 360),
            "collection-complete-receipt": (640, 940, 950, 390, 420, 460),
            "empty": (640, 940, 950, 300, 335, 370),
        },
        DialogSizeClass.PROGRESS: {
            "growth": (950, 950, 950, 480, 510, 570),
            "today": (950, 950, 950, 500, 540, 570),
            "streak": (950, 950, 950, 420, 450, 500),
            "currency": (950, 950, 950, 340, 400, 470),
            "achievements": (950, 950, 950, 570, 570, 570),
            "collection": (950, 950, 950, 570, 570, 570),
            "collection-empty": (950, 950, 950, 360, 400, 460),
        },
        DialogSizeClass.LOADOUT: {
            "default": (980, 1000, 1020, 680, 680, 680),
        },
        DialogSizeClass.PLANT_STORY: {
            "default": (740, 760, 780, 480, 500, 680),
        },
        DialogSizeClass.SPECIES_DETAIL: {
