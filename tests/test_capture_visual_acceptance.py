...
def test_move_occupied_hover_is_independently_validated() -> None:
    ...
    contour_records = [
        {
            ...
            "record_matches_depth_asset": True,
            "draw_rect_matches_planter": True,
            "alpha_outline_available": True,
            "outline_drawn": True,
            "fallback_used": False,
        }
        for slot, depth, variant in (
            (0, "far", "back"),
            (1, "far", "back"),
            (2, "middle", "middle"),
            (3, "middle", "middle"),
    ...
    assert move_planter_contour_issue_codes(contours) == ()
    contours["records"][4]["fallback_used"] = True
    assert "move-contour:slot-4:fallback" in (
        move_planter_contour_issue_codes(contours)
    )
...
def test_growth_charge_ready_and_success_require_rendered_carryover() -> None:
    common = {
        ...
        "progress_value": 50,
        "reward_label": "Reward for reaching Sprout",
    ...
    success = {
        **common,
        ...
        "reward_label": "Reward earned for reaching Sprout",
...
def _reviewer_reward_content() -> dict[str, object]:
    settled_copy = "Growth goes to unfinished plants; any extra is stored."
    ...
    rows: dict[str, object] = {
        ...
        "reward-details-action-copy": {
            "collapsed_action_copy": "Reward details ›",
        ...
        "session-footer-reconciliation": {
            ...
            "footer_growth_units": 6_000,
            "live_growth_units": 6_000,
            "footer_coins": 14,
            "live_coins": 14,
            "footer_finds": 1,
            "live_finds": 1,
            "footer_copy": ["+60", "+14", "3"],
            "footer_discoveries": 3,
            "live_discoveries": 3,
        },
...
def _reviewer_hud_viewport_matrix() -> dict[str, object]:
    ...
    rows["1280x800-collapsed"].update({
        ...
        "collapsed_next_visible": False,
        "collapsed_next_copy": "",
        "collapsed_next_declared_copy": "",
        "collapsed_next_full_copy": "",
