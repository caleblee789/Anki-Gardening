...
def test_catalog_prices_tiers_charges_and_ultra_pity_match_the_product_contract():
    ...
    entry_categories = collection_categories(collection_entry_registry())
    assert [key for key, _label in entry_categories] == [
        "plants", "scenery", "garden_features", "garden_beds", "growth_items"
    ]
    assert ("garden_features", "Garden decorations") in entry_categories
