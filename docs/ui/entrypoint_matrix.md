...
|---|---|---|---|
| Deck Browser | Anki Garden home card | Shows streak, reviews, vitality, weather, daily growth, and plant thumbnails. | Text/emoji fallback; Refresh retries. |
...
| Dashboard | **Open Settings** | Opens appearance preview and persisted theme/motion controls. | Existing settings remain active if saving fails. |
