...
|---|---|---|---|
| Deck Browser | Anki Garden home card | Shows noninteractive garden art, the Garden name, nurtured plant and Growth, and **Open Garden**. Today, Anki streak, and Garden Coins stay in their full-Garden/Progress surfaces. | Named artwork fallback and Retry appear for recoverable errors while **Open Garden** remains reachable. |
...
| Selected plant card | **Nurture**, **Fertilize**, **Growth Charge**, **Move**, **Story** | Routes future full-answer Growth, opens the dedicated Fertilizer dialog, opens the target-specific Growth Charge dialog, begins direct scene placement, or opens the plant timeline. | Disabled or failed actions explain the problem without mutating saved state. |
