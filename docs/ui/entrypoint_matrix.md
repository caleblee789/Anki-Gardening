...
| Full Garden scene | Nursery building (`garden.nursery.open`) | Opens the tabbed catalog for starter selection, Plants, Fertilizer and Boosters, Garden Spaces, and Weather and Scenery. | Unknown landmark actions fail closed. The target is disabled during Move and absent from home. |
