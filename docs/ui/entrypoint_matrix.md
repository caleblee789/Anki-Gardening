...
| Dashboard | **Garden settings** | Opens a responsive, scrollable preview with persisted theme, motion, daily-goal, and home-visibility controls. | Existing settings remain active if saving fails. |
