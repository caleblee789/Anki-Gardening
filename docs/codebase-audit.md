...
schema 18 / Verdant Twilight V6 section is current; later dated sections are
...
| State boundary | Schema 18 preserves schema-17 resumable onboarding and schema-16 environment/Growth-source state, then adds a separately bounded completed-purchase replay ledger. | Schema-17 migration backup/preservation, onboarding, environment/Charge/drop/purchase round-trip, malformed-state, rollback, and package tests. |
