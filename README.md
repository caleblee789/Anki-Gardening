...
candidate. The new package, hashes, manifests, native captures, and audit will
be bound only after the fresh 2.2.0 evidence run; human, platform,
accessibility, and mixed-DPI gates remain separate.
