...
- **Show garden on home screens**: Show the compact garden preview in Deck
  ...
  streak, Garden Coins, and **Open Garden**; its plants and Nursery cannot be
  clicked.
...
Weather and Scenery are no longer settings choices. Open the cottage or
**Progress**, choose **Weather & Scenery**, then equip one of each or change the
