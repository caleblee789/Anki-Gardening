...
GARDEN_ICON_PATHS: dict[str, str] = {
    ...
    "environment-discovery": '<path d="M4 18.5h16M5.5 17l4.5-5 3 3 2-2 3.5 4"/><path d="M17.5 3.5v5M15 6h5M7 8.5h.01"/>',
    ...
    "settings": '<path d="M9.7 2.8h4.6l.5 2.2c.6.2 1.1.5 1.6.9l2.1-.7 2.3 4-1.6 1.5c.1.7.1 1.3 0 2l1.6 1.5-2.3 4-2.1-.7c-.5.4-1 .7-1.6.9l-.5 2.2H9.7l-.5-2.2c-.6-.2-1.1-.5-1.6-.9l-2.1.7-2.3-4 1.6-1.5a7 7 0 0 1 0-2L3.2 9.2l2.3-4 2.1.7c.5-.4 1-.7 1.6-.9l.5-2.2Z"/><circle cx="12" cy="12" r="3.1"/>',
