...
CAPTURE_SCENARIO_SCHEMA_VERSION = 2
EXHAUSTIVE_CAPTURE_SCENARIO_CALLABLES: tuple[tuple[str, str], ...] = (
    ...
    ("starter-garden-onboarding", "_capture_starter_garden"),
    ("starter-nursery-plants", "_capture_starter_nursery"),
    ("starter-selection-confirmation", "_capture_starter_confirmation"),
    ("starter-action-above-footer", "_capture_starter_action_above_footer"),
    ("deck-browser-home", "_capture_deck_browser"),
    ("overview-home", "_capture_overview"),
    ("full-garden", "_capture_full_garden"),
    ("hover-outline", "_capture_hover_outline"),
    ("selected-plant-not-nurtured", "_capture_selected_card"),
    ("selected-plant-nurtured", "_capture_nurture"),
    ("fertilizer-unaffordable", "_capture_fertilize"),
    ("fertilizer-affordable", "_capture_fertilize_affordable"),
    ("fertilizer-active", "_capture_fertilize_active"),
    ("move-mode", "_capture_move"),
    ("plant-story", "_capture_story"),
    ("active-deck-browser-home-after-nurture", "_capture_active_deck_browser_after_nurture"),
    ("active-overview-home-after-nurture", "_capture_active_overview_after_nurture"),
    ("growth-zero", "_capture_growth_zero"),
    ("growth-nonzero", "_capture_growth_nonzero"),
    ("streak-new", "_capture_streak_new"),
    ("streak-active", "_capture_streak_active"),
    ("coins-zero", "_capture_coins_zero"),
    ("coins-activity", "_capture_coins_activity"),
    ("progress-overview-redirect-growth", "_capture_progress_today"),
    ("progress-achievements", "_capture_progress_achievements"),
    ("progress-collection", "_capture_progress_collection"),
    ("collection-species-overview", "_capture_species_overview"),
    ("collection-loadout-detail", "_capture_collection_loadout_detail"),
    ("collection-preview-active", "_capture_collection_preview_active"),
    ("collection-preview-restored", "_capture_collection_preview_restored"),
    ("nursery-plants", "_capture_nursery_plants"),
    ("nursery-fertilizer-booster", "_capture_nursery_fertilizer_booster"),
    ("nursery-garden-spaces", "_capture_nursery_garden_spaces"),
    ("nursery-weather-scenery", "_capture_nursery_weather_scenery"),
    ("settings-home-preview-disabled", "_capture_settings_home_preview_disabled"),
    ("settings-display", "_capture_settings_display"),
    ("settings-display-advanced-open", "_capture_settings_display_advanced"),
    ("diagnostics-clean", "_capture_settings_troubleshooting"),
    ("diagnostics-warning", "_capture_settings_warning"),
    ("long-garden-name", "_capture_long_garden_name"),
    ("long-plant-name", "_capture_long_plant_name"),
    ("four-digit-coin-balance", "_capture_four_digit_coin_balance"),
    ("growth-near-stage-completion", "_capture_growth_near_stage_completion"),
    ("all-six-beds-occupied", "_capture_all_six_beds"),
    ("plant-at-every-stage", "_capture_all_six_stages"),
    ("fully-grown-plant-without-fertilize", "_capture_fully_grown_without_fertilize"),
    ("popover-plot-1", "_capture_popover_slot"),
    ("popover-plot-2", "_capture_popover_slot"),
    ("popover-plot-3", "_capture_popover_slot"),
    ("popover-plot-4", "_capture_popover_slot"),
    ("popover-plot-5", "_capture_popover_slot"),
    ("popover-plot-6", "_capture_popover_slot"),
    ("move-occupied-empty-destinations", "_capture_move_mixed_destinations"),
    ("fertilizer-expiring-under-minute", "_capture_fertilizer_expiring"),
    ("fertilizer-replacement-confirmation", "_capture_fertilizer_replacement_confirmation"),
    ("watering-can-garden-plot-1", "_capture_watering_can_garden_plot"),
    ("watering-can-garden-plot-2", "_capture_watering_can_garden_plot"),
    ("watering-can-garden-plot-3", "_capture_watering_can_garden_plot"),
    ("watering-can-garden-plot-4", "_capture_watering_can_garden_plot"),
    ("watering-can-garden-plot-5", "_capture_watering_can_garden_plot"),
    ("watering-can-garden-plot-6", "_capture_watering_can_garden_plot"),
    ("watering-can-deck-browser-plot-1", "_capture_watering_can_home_plot"),
    ("watering-can-deck-browser-plot-3", "_capture_watering_can_home_plot"),
    ("watering-can-deck-browser-plot-5", "_capture_watering_can_home_plot"),
    ("watering-can-overview-plot-2", "_capture_watering_can_home_plot"),
    ("watering-can-overview-plot-4", "_capture_watering_can_home_plot"),
    ("watering-can-overview-plot-6", "_capture_watering_can_home_plot"),
    ("collection-several-discovered", "_capture_collection_several"),
    ("collection-no-filter-matches", "_capture_collection_no_matches"),
    ("achievement-completed", "_capture_achievement_completed"),
    ("clear-recall-canonical-projection", "_capture_clear_recall_projection"),
    ("streak-at-risk", "_capture_streak_at_risk"),
    ("streak-missed-day", "_capture_streak_missed_day"),
    ("streak-achievement-earned-next", "_capture_streak_achievement_states"),
    ("nursery-item-owned", "_capture_nursery_owned_item"),
    ("nursery-item-locked", "_capture_nursery_locked_item"),
    ("nursery-purchase-success", "_capture_nursery_purchase_success"),
    ("nursery-final-row-above-footer", "_capture_nursery_final_row"),
    ("missing-artwork-graphical-fallback", "_capture_missing_artwork_fallback"),
    ("settings-unsaved-changes", "_capture_settings_unsaved"),
    ("settings-validation-error", "_capture_settings_validation_error"),
    ("diagnostics-expanded", "_capture_diagnostics_expanded"),
    ("production-build-controls-absent", "_capture_production_controls_absent"),
    ("reviewer-find-common-reduced-motion", "_capture_reviewer_find_common"),
    ("reviewer-find-environment", "_capture_reviewer_find_environment"),
    ("reviewer-find-stacked-sync", "_capture_reviewer_find_stacked_sync"),
    ("reduced-motion-enabled", "_capture_reduced_motion"),
    ("keyboard-focus-state", "_capture_keyboard_focus"),
    ("starter-placement", "_capture_starter_placement"),
    ("starter-completion", "_capture_starter_completion"),
    ("home-preview-loading", "_capture_home_preview_phase"),
    ("home-preview-error", "_capture_home_preview_phase"),
    ("home-preview-stale", "_capture_home_preview_phase"),
    ("onboarding-persistence-error", "_capture_onboarding_persistence_error"),
    ("move-persistence-error", "_capture_move_persistence_error"),
    ("collection-known-not-collected-overview", "_capture_known_uncollected_species_overview"),
    ("purchase-confirmation-species", "_capture_purchase_confirmation_species"),
    ("purchase-confirmation-growth-charge", "_capture_purchase_confirmation_growth_charge"),
    ("purchase-confirmation-environment", "_capture_purchase_confirmation_environment"),
    ("purchase-confirmation-fertilizer-application", "_capture_purchase_confirmation_fertilizer_application"),
    ("purchase-confirmation-fertilizer-extension", "_capture_purchase_confirmation_fertilizer_extension"),
    ("purchase-confirmation-garden-bed", "_capture_purchase_confirmation_bed"),
    ("purchase-confirmation-loading-disabled", "_capture_purchase_confirmation_loading"),
    ("purchase-error-insufficient-coins", "_capture_purchase_error_insufficient"),
    ("purchase-error-persistence-failure", "_capture_purchase_error_persistence"),
    ("purchase-error-item-unavailable", "_capture_purchase_error_unavailable"),
    ("purchase-error-already-owned", "_capture_purchase_error_already_owned"),
    ("purchase-error-invalid-target", "_capture_purchase_error_invalid_target"),
    ("purchase-error-stale-price", "_capture_purchase_error_stale_price"),
    ("purchase-error-stale-balance", "_capture_purchase_error_stale_balance"),
    ("purchase-success-inventory-collection", "_capture_purchase_success_collection"),
    ("purchase-success-fertilizer-applied", "_capture_purchase_success_fertilizer"),
    ("purchase-success-garden-bed-unlocked", "_capture_purchase_success_bed"),
    ("nursery-empty-state", "_capture_nursery_empty_state"),
    ("collection-environment-mechanics", "_capture_collection_environment_mechanics"),
    ("collection-loadout-persistence-error", "_capture_collection_loadout_persistence_error"),
    ("collection-origin-plant-placement", "_capture_collection_origin_plant_placement"),
    ("growth-charge-use-ready", "_capture_growth_charge_ready"),
    ("growth-charge-empty-inventory", "_capture_growth_charge_empty_inventory"),
    ("growth-charge-loading-disabled", "_capture_growth_charge_loading"),
    ("growth-charge-stale-inventory", "_capture_growth_charge_stale_inventory"),
    ("growth-charge-invalid-target", "_capture_growth_charge_invalid_target"),
    ("growth-charge-persistence-failure", "_capture_growth_charge_persistence_failure"),
    ("growth-charge-success-stage-reward", "_capture_growth_charge_success_reward"),
)
...
CAPTURE_RENDERER_DEPENDENCY_GROUPS: dict[str, tuple[str, ...]] = {
    ...
    "fertilizer": (
        "family:FertilizerDialog",
        "family:FertilizerReplacementDialog",
        "label:purchase-confirmation-fertilizer-application",
        "label:purchase-confirmation-fertilizer-extension",
        "label:purchase-success-fertilizer-applied",
    ),
    "growth-charge": (
        "family:GrowthChargeConfirmationDialog",
        "label:purchase-confirmation-growth-charge",
    ),
    "plant-story": ("family:PlantStoryDialog",),
    "garden-purchase": (
        "label:purchase-confirmation-species",
        "label:purchase-confirmation-garden-bed",
    ),
    "nursery-plants": (
        ...
        "label:purchase-success-inventory-collection",
    ),
    "nursery-supplements": (
    ...
    "nursery-environment": (
        ...
        "label:purchase-confirmation-environment",
    ),
    "nursery-spaces": (
        "label:nursery-garden-spaces",
        "label:purchase-success-garden-bed-unlocked",
    ),
    "nursery-transactions": (
        "label:nursery-purchase-success",
        "prefix:purchase-success-",
    ),
    "purchase-errors": ("prefix:purchase-error-",),
    "purchase-fertilizer": (
        "label:fertilizer-replacement-confirmation",
        "label:purchase-confirmation-fertilizer-application",
        "label:purchase-confirmation-fertilizer-extension",
    ),
    "purchase-loading": ("label:purchase-confirmation-loading-disabled",),
}
...
CAPTURE_RENDERER_EXACT_MODULE_OWNERS: dict[str, tuple[str, ...]] = {
    "ui/home_widget.py": (
        ...
        "label:starter-overview-home",
        "label:deck-browser-home",
        "label:overview-home",
        "label:active-deck-browser-home-after-nurture",
        "label:active-overview-home-after-nurture",
        "prefix:watering-can-deck-browser-",
        "prefix:watering-can-overview-",
        "prefix:home-preview-",
    ),
    "hooks/reviewer.py": ("prefix:reviewer-",),
    ...
    "ui/garden_studio.py": (
        ...
        "label:settings-unsaved-changes",
        "label:settings-validation-error",
        "label:reduced-motion-enabled",
    ),
    "ui/scene.py": (
        "family:GardenDashboard",
        "label:settings-home-preview-disabled",
        "label:settings-display",
        "label:settings-display-advanced-open",
        "label:settings-unsaved-changes",
...
CAPTURE_RENDERER_SHARED_CLASS_METHODS: dict[str, tuple[str, ...]] = {
    "GardenDashboard": (
        ...
        "_local_date",
        "resizeEvent",
        "_dashboard_content_width",
        "_sync_dashboard_responsive_geometry",
        "_sync_dashboard_content_minimum_height",
        "_position_scene_overlays",
        "_header_actions_content_width",
        "_apply_responsive_layout",
        "_sync_header_minimum_heights",
        "_is_widget_descendant",
        "eventFilter",
        "keyPressEvent",
        "done",
        "_update_scene_height",
        "_sync_feedback_panel_visibility",
        "refresh_external_surfaces",
        "_refresh_after_commit",
        "_on_state_changed",
        "show_same_day_catchup_feedback",
        "_plant_scene_payload",
        "_settings_scene_snapshot",
        "_resolved_asset_payload",
        "_booster_text",
        "focusNextPrevChild",
        "_clear_layout",
        "_refresh_unlock_card",
    ),
    "GardenDetailsDialog": (
        "__init__",
        "open_metric",
        "_sync_context_action",
        "_clear_layout",
        "_label",
        "_section_label",
        "_defer_complete_section_below_fold",
        "_register_complete_section_boundary",
        "_sync_complete_section_boundaries",
        "resizeEvent",
        "_value_row",
        "_disclosure",
        "refresh",
    ...
    "NurseryDialog": (
        ...
        "_show_nursery_toast",
        "_sync_nursery_feedback_host",
        "_refit_nursery_feedback",
        "resizeEvent",
        "_clear_catalog",
        "_clear_section",
        "_section_label",
        ...
        "_dismiss_product_receipt",
        "_show_purchase_receipt",
        "_focus_purchase_result",
        "_show_product_receipt",
        "_follow_receipt_action",
        "_sync_catalog_intro",
        "refresh",
        "_show_result",
    ...
    "PurchaseConfirmationDialog": (
        ...
        "_toggle_more_details",
        "_activate_primary",
        "_set_submitting",
        "_advance_progress_indicator",
        "_submit",
        "_commit",
...
CAPTURE_RENDERER_STATE_CLASS_METHODS: dict[str, tuple[str, ...]] = {
    "garden-onboarding": (
        "GardenDashboard._present_starter_setup_if_needed",
        ...
        "GardenDashboard._onboarding_completion_receipt",
        "GardenDashboard._onboarding_failure_receipt",
        "GardenDashboard._set_onboarding_shield",
        "GardenDashboard._on_starter_selected",
        "GardenDashboard._complete_onboarding",
        "GardenDashboard._dismiss_onboarding",
        "GardenDashboard._complete_first_nurture_guidance",
        "GardenDashboard._clear_onboarding_confirmation",
    ),
    "progress": (
        "GardenDashboard._open_progress",
        "GardenDashboard._restore_progress_focus",
        "GardenDashboard._open_metric_details",
        "GardenDashboard._restore_metric_focus",
    ...
    "progress-growth": (
        ...
        "GardenProgressDialog.open_growth_charges",
    ),
    "progress-streak": (
        "GardenDetailsDialog._refresh_streak",
    ),
    "progress-coins": (
        "GardenDetailsDialog._reward_result_text",
        "GardenDetailsDialog._reward_source_text",
        "GardenDetailsDialog._garden_find_result_text",
        "GardenDetailsDialog._add_recent_reward_history",
        "GardenDetailsDialog._add_recent_garden_finds",
        "GardenDetailsDialog._refresh_currency",
        "GardenDetailsDialog._set_transaction_filter",
    ),
    "collection": (
        ...
        "GardenDashboard._return_to_garden_from_collection",
        "GardenDashboard._begin_collection_placement",
        "GardenDashboard._set_collection_placement",
    ),
    "species-overview": (
    ...
    "garden-selection": (
        ...
        "PlantInfoCard._layout_actions",
        "PlantInfoCard.resizeEvent",
        "PlantInfoCard.set_docked_mode",
        "PlantInfoCard.set_onboarding_guidance",
        "PlantInfoCard.set_selected",
        "GardenDashboard._on_scene_selection",
        "GardenDashboard._on_landmark_activated",
        "GardenDashboard._set_plant_card_mode",
        ...
        "GardenDashboard._choose_another_plant",
    ),
    "garden-move": (
        ...
        "GardenDashboard._begin_move",
        "GardenDashboard._refresh_rearrange_destinations",
        "GardenDashboard._cancel_move",
        "GardenDashboard._finish_failed_move",
    ...
    "nursery": ("GardenDashboard._open_nursery",),
    "settings": (
        "GardenDashboard._open_customize",
        "GardenDashboard._open_settings",
        "GardenDashboard._settings_scene_snapshot",
    ),
    "fertilizer": (
    ...
    "growth-charge": ("GardenDashboard._open_growth_charges_for_plant",),
    "plant-story": ("GardenDashboard._open_plant_story",),
    "garden-purchase": (
        "GardenDashboard._purchase_species",
        "GardenDashboard._purchase_bed",
        "GardenDashboard._confirm_dashboard_purchase",
    ),
    "nursery-plants": (
        "NurseryDialog._plant_artwork",
        "NurseryDialog._plant_stage_strip",
        "NurseryDialog._plant_stage_carousel",
        "NurseryDialog._currently_growing_strip",
        "NurseryDialog._view_in_garden",
        "NurseryDialog._return_to_garden",
        "NurseryDialog._owned_card",
        "NurseryDialog._return_to_collection_copy",
        "NurseryDialog._confirm_return_to_collection",
        "NurseryDialog._available_card",
        "NurseryDialog._starter_card",
        "NurseryDialog._choose_starter",
        "NurseryDialog._purchase_species",
    ...
    "nursery-transactions": (
        "NurseryDialog._execute_purchase",
        "NurseryDialog._stage_purchase_result",
        "NurseryDialog.handle_purchase_result",
        "NurseryDialog._handle_purchase_dialog_route",
    ),
    "purchase-errors": (
        "PurchaseConfirmationDialog._failure_tone",
        "PurchaseConfirmationDialog._transaction_timed_out",
        "PurchaseConfirmationDialog._clear_status",
        "PurchaseConfirmationDialog._show_failure",
        "PurchaseConfirmationDialog._show_status_banner",
    ),
    "purchase-loading": (
        "PurchaseConfirmationDialog._transaction_timed_out",
    ),
...
CAPTURE_RENDERER_HIDDEN_CALL_EXCEPTIONS: dict[str, tuple[str, ...]] = {
    ...
    "GardenDashboard._build_ui": (
        ...
        "GardenDashboard._open_collection",
        "GardenDashboard._open_fertilizer_menu",
        "GardenDashboard._open_growth_charges_for_plant",
        "GardenDashboard._open_metric_details",
        "GardenDashboard._open_nursery",
        "GardenDashboard._begin_move",
        "GardenDashboard._open_plant_story",
        "GardenDashboard._open_progress",
        "GardenDashboard._open_settings",
        "GardenDashboard._open_starter_nursery",
        "GardenDashboard._place_plant",
    ...
    "GardenDashboard.eventFilter": ("GardenDashboard._cancel_move",),
    "GardenDashboard.keyPressEvent": ("GardenDashboard._cancel_move",),
    "GardenDashboard.done": ("GardenDashboard._cancel_move",),
    "GardenDashboard._on_state_changed": (
        "GardenDashboard._refresh_move_scene",
    ),
    "GardenDashboard.resizeEvent": (
        "GardenDashboard._position_onboarding_coachmark",
        "GardenDashboard._position_plant_card",
    ),
    "GardenDashboard._open_collection": (
    ...
    "NurseryDialog._show_purchase_receipt": (
        "NurseryDialog._dismiss_product_receipt",
        "NurseryDialog._follow_receipt_action",
        "NurseryDialog._open_customize_from_nursery",
        "NurseryDialog._refit_nursery_feedback",
    ),
    ...
    "PurchaseConfirmationDialog.__init__": (
        "PurchaseConfirmationDialog._transaction_timed_out",
        "PurchaseConfirmationDialog._update_remaining_time",
    ),
    "PurchaseConfirmationDialog._apply_quote": (
        "PurchaseConfirmationDialog._clear_status",
        "PurchaseConfirmationDialog._show_failure",
    ),
    "PurchaseConfirmationDialog._render_presentation": (
        "PurchaseConfirmationDialog._update_remaining_time",
    ),
    "PurchaseConfirmationDialog._submit": (
        "PurchaseConfirmationDialog._clear_status",
    ),
    "PurchaseConfirmationDialog._commit": (
        "PurchaseConfirmationDialog._show_failure",
        "PurchaseConfirmationDialog._show_status_banner",
        "PurchaseConfirmationDialog._clear_status",
    ),
...
def capture_contract_digest(profile: str) -> str:
    """Return the exact compiled v25 contract digest used by the runtime."""
...
# v25 runtime topology is compiled from one Qt-free SurfaceSpec registry.  The
...
_REVIEWER_CAPTURE_LABELS = frozenset(
    surface.stable_id
    for surface in REGISTRY.active_surfaces
    if surface.stable_id.startswith("reviewer-find-")
)
_HOME_CAPTURE_LABELS = frozenset(
    surface.stable_id
    for surface in REGISTRY.active_surfaces
...
class _UiFaceCaptureRunner:
    ...
    def _partition_failure_records(
        ...
        for raw in getattr(self, "_failures", ()):
            ...
            if (
                ...
                and captured.get(label) is True
                and not self._post_capture_lifecycle_failure(reason)
            ):
    ...
    @staticmethod
    def _external_widget_bounds_evidence(
        widget: Any,
        container: Any,
    ) -> dict[str, Any]:
        """Return bounds for widgets outside the audited container tree."""
        ...
        try:
            origin = container.mapFromGlobal(
            ...
            return {
                "bounds": bounds,
                "container_size": container_size,
                "visible": bool(widget.isVisible() and container.isVisible()),
                "intersects": intersects,
                "contained": contained,
            }
        except (AttributeError, RuntimeError, TypeError, ValueError):
    ...
    def _reviewer_overlay_geometry_audit(
        ...
        reviewer = getattr(mw, "reviewer", None)
        expected_parent = getattr(reviewer, "web", None)
            ...
            for control in mw.findChildren(QAbstractButton):
                try:
                    ...
                    if not any(
                        ...
                        continue
                    control_evidence = self._external_widget_bounds_evidence(
                        control,
                        parent,
                    )
                    if not (
        ...
        parent_is_reviewer_webview = bool(
            expected_parent is not None and parent is expected_parent
        )
        reviewer_state_is_review = str(getattr(mw, "state", "") or "") == "review"
        cleanup_handler = getattr(
            getattr(self.app, "reviewer_hooks", None),
            "on_state_change",
            None,
        )
        passed = bool(
            toast is not None
            and toast.isVisible()
            and reviewer_state_is_review
            and parent_is_reviewer_webview
            and callable(cleanup_handler)
        ...
        return {
            ...
            "parent_contract": "mw.reviewer.web-exact",
            "reviewer_state_is_review": reviewer_state_is_review,
            "non_review_cleanup_registered": callable(cleanup_handler),
    ...
    def _native_layout_telemetry_audit(
        ...
        window_mode = raw.get("windowMode")
        if window_mode not in {"canvas", "workspace", "content"}:
            issue_codes.append("invalid-window-mode")
            window_mode = ""
        content_fit_pending = raw.get("contentFitPending")
        if type(content_fit_pending) is not bool:
            issue_codes.append("invalid-content-fit-pending")
        elif content_fit_pending and window_mode != "canvas":
            issue_codes.append("content-fit-not-settled")
        safety_scroll_active = raw.get("safetyScrollActive")
        if type(safety_scroll_active) is not bool:
            issue_codes.append("invalid-safety-scroll-active")
            safety_scroll_active = False
        for bounds_name in ("clientBounds", "bodyBounds"):
            bounds = raw.get(bounds_name)
            if bounds_name == "bodyBounds" and window_mode == "canvas" and bounds is None:
                continue
            if (
                not isinstance(bounds, dict)
                or set(bounds) != {"x", "y", "width", "height"}
                or any(type(bounds.get(key)) is not int for key in bounds)
                or int(bounds.get("width", 0)) <= 0
                or int(bounds.get("height", 0)) <= 0
            ):
                issue_codes.append(f"invalid-{bounds_name}")
        footer_bounds = raw.get("footerBounds")
        if footer_bounds is not None and (
            not isinstance(footer_bounds, dict)
            or set(footer_bounds) != {"x", "y", "width", "height"}
            or any(type(footer_bounds.get(key)) is not int for key in footer_bounds)
            or int(footer_bounds.get("width", 0)) <= 0
            or int(footer_bounds.get("height", 0)) <= 0
        ):
            issue_codes.append("invalid-footerBounds")
        settled_size = raw.get("settledSize")
        if (
            ...
            or settled_size.get("width") != int(root.width())
            or settled_size.get("height") != int(root.height())
        ):
            issue_codes.append("invalid-settled-size")
        ...
        elif window_mode == "canvas" and overflow_owner_count != 0:
            issue_codes.append("canvas-overflow-owner")
        elif window_mode == "workspace" and overflow_owner_count != 1:
            issue_codes.append("workspace-overflow-owner")
        elif window_mode == "content" and (
            (bool(safety_scroll_active) and overflow_owner_count != 1)
            or (not bool(safety_scroll_active) and overflow_owner_count != 0)
        ):
            issue_codes.append("content-overflow-owner")
        if window_mode != "content" and bool(safety_scroll_active):
            issue_codes.append("safety-scroll-outside-content-mode")
        if (
            window_mode == "content"
            and bool(safety_scroll_active)
            and not bool(getattr(root, "_content_screen_limited", False))
        ):
            issue_codes.append("safety-scroll-without-screen-limit")
        owner_rows = 0
    ...
    def _unpainted_client_pixel_audit(
        ...
        if label in _REVIEWER_CAPTURE_LABELS:
            overlay = dict(annotation.get("reviewer_overlay_geometry", {}) or {})
            bounds = list(overlay.get("overlay_bounds", ()) or ())
    ...
    def _capture_fixture_postcondition(
        ...
        *,
        ...
        if kind == "reviewer":
            ...
            if state_name == "starter-selection-confirmation":
                semantic_buttons = {
                    str(button.property("semanticId") or ""): button
                    for button in widget.findChildren(QAbstractButton)
                    if str(button.property("semanticId") or "")
                }
                require(
                    "starter_confirmation",
                    str(widget.property("semanticId") or "")
                    == "onboarding.starter-confirmation"
                    and all(
                        key in semantic_buttons
                        and semantic_buttons[key].isVisible()
                        and semantic_buttons[key].isEnabled()
                        for key in (
                            "onboarding.starter-back",
                            "onboarding.starter-confirm",
                        )
                    ),
                    {"title": title, "buttons": sorted(semantic_buttons)},
                )
                ...
                require(
                    ...
                    str(widget.property("semanticId") or "")
                    == "purchase.fertilizer-replacement"
                    and bool(getattr(widget.quote, "replacement_required", False))
                    and str(
                        widget.purchase_action.property("semanticId") or ""
                    ) == "purchase.primary-action"
                    and widget.purchase_action.isVisible()
                    ...
                    and widget.cancel_action.isEnabled(),
                    {
                        ...
                        "replacement_required": bool(
                            getattr(widget.quote, "replacement_required", False)
                        ),
                    },
                )
        ...
        *,
        ...
        try:
            ...
            if pixmap.save(str(temporary_path), "png"):
                ...
                annotation["passed"] = gross_capture_passed
                capture_acceptance = {
                    "policy": "gross-failures-only",
                    "gross_checks": gross_checks,
                    "passed": gross_capture_passed,
        ...
        *,
        ...
        try:
            ...
            if (
                ...
                raise RuntimeError("cursor did not reach the neutral corner")
            QToolTip.hideText()
            return 160
        except Exception as exc:
            self._failures.append({
        ...
        *,
        ...
        def advance_after_capture() -> None:
            ...
            def cleanup_ready() -> None:
                ...
                if cleanup_settled or elapsed_ms >= 1500.0:
                    phase_timings.setdefault(
                        scheduled_label,
                        {},
                    ...
                    if not cleanup_settled:
                        self._failures.append({
                            "label": scheduled_label,
                            "reason": "Capture cleanup did not settle within 1500 ms",
                        })
                    for record in reversed(getattr(self, "_capture_records", [])):
                        if record.get("label") == scheduled_label:
                            self._write_surface_progress(record)
    ...
    def _capture_starter_confirmation(self) -> None:
        ...
        self._capture_and_advance(
            ...
            close_callback=lambda: self._dispose_capture_widget(dialog),
        ...
        *,
        ...
        def capture_ready() -> None:
            ...
            self._capture_and_advance(
                ...
                dialog,
                capture_delay_ms=420,
                close_callback=lambda: self._dispose_capture_widget(
                    dialog,
                    owner=dashboard,
                    owner_attribute="nursery_dialog",
                ),
                cleanup_predicate=lambda: self._capture_widget_disposed(dialog),
                close_ms=780,
                next_ms=1200,
    ...
    def _growth_charge_capture_annotation(
        ...
        result_matches_quote = bool(
            ...
            == max(0, int(quote.current_growth))
            and int(dialog.compact_summary_card.property("projectedGrowth") or -1)
            == max(0, int(quote.projected_growth))
            and int(dialog.compact_summary_card.property("inventoryBefore") or -1)
            == max(0, int(quote.inventory_before))
            and int(dialog.compact_summary_card.property("inventoryAfter") or -1)
            == max(0, int(quote.inventory_after))
        )
        plant_details_visible = bool(
        ...
        if variant == "ready":
            ...
            conditions.extend([
                ...
                result_matches_quote,
                alert_visible,
                str(dialog.alert.property("growthChargeAlertStatus") or "")
                == "stale_inventory",
                inventory == 1,
            ...
            conditions.extend([
                alert_visible,
                str(dialog.alert.property("semanticId") or "")
                == "growth-charge.alert",
                str(dialog.alert.property("growthChargeAlertStatus") or "")
                == expected_status,
            ...
            conditions.extend([
                ...
                == "sprout",
                int(dialog.receipt.property("receiptRewardTotal") or 0)
                == reward_total,
                int(dialog.receipt.property("receiptGrowthGranted") or 0)
                == max(0, int(getattr(outcome, "growth_granted", 0))),
        ...
        self._capture_annotations[label].update({
            ...
            "ready_with_stale_inventory_warning": bool(
                ...
                or (
                    alert_visible
                    and str(
                        dialog.alert.property("growthChargeAlertStatus") or ""
                    ) == "stale_inventory"
                    and quote is not None
                    and bool(quote.ready)
            ...
            "seed_to_sprout_receipt": bool(
                ...
                or (
                    receipt_visible
                    and str(
                        dialog.receipt.property("receiptPreviousStage") or ""
                    ) == "seed"
                    and str(
                        dialog.receipt.property("receiptResultingStage") or ""
                    ) == "sprout"
                )
            ),
            "active_scroll_count": len(active_scrolls),
        ...
        def dashboard_ready() -> None:
            ...
            def close_dialog() -> None:
                ...
                self._dispose_capture_widget(
                    dialog,
                    owner=self.app.dashboard,
                    owner_attribute="growth_charge_dialog",
                )
                cleanup()
        ...
        def dashboard_ready() -> None:
            ...
            def audit_empty_state() -> None:
                ...
                visible_labels = {
                    ...
                    if label_widget.isVisibleTo(dialog)
                }
                visible_buttons = {
                    _displayed_button_text(button)
        ...
        def dashboard_ready() -> None:
            ...
            def finalize_fixture() -> None:
                ...
                for key, required_widget in required_widgets.items():
                    ...
                    evidence_owner = dialog if key == "toolbar" else viewport
                    ...
                    evidence.update({
                        ...
                        "coordinate_owner": (
                            "progress-dialog" if key == "toolbar" else "card-scroll"
                        ),
                    })
                ...
                annotation = {
                    ...
                    "compact_environment_actions": bool(
                        ...
                        and 34 <= preview_action.height() <= 38
                        and 34 <= unequip_action.height() <= 38
                        and int(
                            preview_action.property("visualControlSize")
                            or preview_action.height()
                        ) == 34
                        and int(
                            unequip_action.property("visualControlSize")
                            or unequip_action.height()
                        ) == 34
                ...
                annotation["passed"] = bool(
                    ...
                    and annotation["canonical_collection_summary"]
            ...
            def fertilizer_ready() -> None:
                ...
                replace = next(
                    (
                        ...
                        if str(
                            button.property("fertilizerActionDisposition") or ""
                        ) == "replace"
    ...
    def _capture_streak_achievement_states(self) -> None:
        ...
        label = "streak-achievement-earned-next"
        ...
        next_bonus_percent = next(
            percent
            for day, percent in STREAK_BONUS_TIERS
            if day == next_bonus_day
        )
        reward_rules = {
            rule.rule_id: rule
            for rule in recurring_reward_presentations(
        ...
        def ready(dialog: Any) -> None:
            ...
            target_card = next(
                (
                    ...
                    if str(card.property("responsiveRegion") or "").startswith(
                        "nursery."
                    )
                    and bool(card.property("unaffordable"))
                    and str(card.property("catalogItemId") or "").startswith(
                        "growth_charge_"
                    )
                ),
                None,
            ...
            if target_card is not None:
                dialog.supplements_scroll.ensureWidgetVisible(
                    target_card,
                    0,
                    24,
                )

            def align_and_audit() -> bool:
                ...
                card_bounds = self._widget_bounds_evidence(target_card, viewport)
                ...
                action = (
                    next(
                        iter(target_card.findChildren(QAbstractButton)),
                        None,
                    )
                    if target_card is not None else None
                )
                action_bounds = self._widget_bounds_evidence(action, viewport)
                geometry = {
                    "interaction": "ensureWidgetVisible",
                    "target_item_id": str(
                        target_card.property("catalogItemId") or ""
                    ) if target_card is not None else "",
                    "target_semantic_id": str(
                        target_card.property("responsiveRegion") or ""
                    ) if target_card is not None else "",
                    "heading": heading_bounds,
                    "card": card_bounds,
                    "action": action_bounds,
                    "action_disabled": bool(
                        action is not None and not action.isEnabled()
                    ),
                    "unaffordable": bool(
                        target_card is not None
                        and target_card.property("unaffordable")
                    ),
                }
                geometry["passed"] = bool(
                    geometry["target_item_id"]
                    and geometry["target_semantic_id"]
                    and card_bounds.get("visible", False)
                    and card_bounds.get("contained", False)
                    and action_bounds.get("visible", False)
                    and action_bounds.get("contained", False)
                    and geometry["action_disabled"]
                    and geometry["unaffordable"]
                )
                self._capture_annotations[label] = {
            ...
            self._wait_for(
                ...
                failure_label=label,
                failure_reason=(
                    "Locked Nursery item did not settle through normal scrolling"
                ),
                on_error=close_dialog,
            )
    ...
    def _capture_missing_artwork_fallback(self) -> None:
        ...
        def ready(dialog: Any) -> None:
            ...
            try:
                ...
                normal_card = getattr(dialog, "environment_feature_card", None)
                visible_preview = getattr(dialog, "environment_feature_art", None)
                ...
                def prepare_capture() -> None:
                    current_card = getattr(
                        dialog,
                        "environment_feature_card",
                        None,
                    )
                    current_preview = getattr(
                        dialog,
                        "environment_feature_art",
                        None,
                    )
                    ...
                    matrix_passed = bool(
                        ...
                        and self.app.storage.state.selected_weather
                        == weather_item.item_id
                    )
                    self._capture_annotations[label] = {
                        ...
                        "missing_artwork_matrix": {
                            ...
                            "selected_weather": str(
                                self.app.storage.state.selected_weather
                            ),
                            "target_weather": weather_item.item_id,
                            "equipped_weather_target": bool(
                                self.app.storage.state.selected_weather
                                == weather_item.item_id
                            ),
    ...
    @staticmethod
    def _leave_capture_reviewer() -> None:
